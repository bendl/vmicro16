...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{apb_wave}
...
\bitbox{20}{\color{lightgray}\rule{\width}{\height}} & \bitbox{1}{\rotatebox{90}{}}
\end{rightwordgroup}\\
...
\centering
\begin{bytefield}{24}
	\memsection{1FFF}{1000}{5}{Shared Memory with Global Monitor \\ \vspace{.5cm} \tiny See vmicro16\_soc\_config.v}\\
	...
	\memsection{007F}{0000}{5}{Scratch Memory \\ \vspace{.5cm} \tiny See vmicro16\_soc\_config.v}
	\end{rightwordgroup}\\
