...
\begin{enumerate}[leftmargin=2\parindent, label=\bfseries CD\arabic*.]
    ...
    \item{Design a synthesisable Verilog RISC core that implements the ISA in \ref{cd:isa}.}\label{cd:core}
...
\item{Provide instructions for explicitly performing signed and unsigned arithmetic.}\label{isa:signed}
\end{enumerate}
