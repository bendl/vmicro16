...
\begin{bytefield}{24}
	...
	\memsection{0202}{0200}{3}{TIMR0}
	\end{rightwordgroup}\\
	\bitbox[]{16}{} & \bitbox[]{16}{$\vdots$ \\[1ex]} \\
	
	\begin{rightwordgroup}{Per-core instances}
	\memsection{0108}{}{1}{Interrupt Mask}\\
	\memsection{0107}{0100}{3}{Interrupt Vector}
	\end{rightwordgroup}\\
	...
	\memsection{007f}{0000}{8}{Scratch Memory \\ \vspace{.5cm} \tiny \vspace{.5cm} \tiny See vmicro16\_soc\_config.v}
	\end{rightwordgroup}\\
...
\bitbox{14}{\color{lightgray}\rule{\width}{\height}} &
\bitbox{1}{R} &
\bitbox{1}{S}
\end{rightwordgroup} \\
...
\inputminted[fontsize=\tiny,baselinestretch=1,linenos]{systemverilog}{../../vmicro16/top_ms.v}

\section*{apb\_intercon.v}
The 
    \inputminted[fontsize=\tiny,baselinestretch=1,linenos]{systemverilog}{../../vmicro16/top_ms.v}
